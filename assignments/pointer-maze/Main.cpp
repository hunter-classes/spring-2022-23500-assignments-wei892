 ...
 */
const std::string kYourName = "Weilin";

/* Change these constants to contain the paths out of your mazes. */
const std::string kPathOutOfNormalMaze = "ESWSEWSEENESNNNW";   
const std::string kPathOutOfTwistyMaze = "TODO: Replace this string with your pa;.th out of the twisty maze.";
